              ...
              builder: (context, jR, child) => ValueListenableBuilder(
                  ...
                  builder: (context, jA, child) => NextPreviousButtons(
                        ...
                        isNextButtonEnabled: jR.text.isNotEmpty &&
                            ...
                            double.parse(jR.text) >= minJointRoughnessValue &&
                            double.parse(jR.text) <= maxJointRoughnessValue &&
                            jA.text.isNotEmpty &&
                            double.tryParse(jA.text) != null &&
                            double.parse(jA.text) >= minJointAlterationValue &&
                            double.parse(jA.text) <= maxJointAlterationValue,
                        onNext: () {
                          QSlope? qSlope = widget.qSlope.value;
                          if (qSlope != null) {
