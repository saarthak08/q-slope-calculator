                      ...
                      builder: (context, oF, child) => NextPreviousButtons(
                            ...
                            onNext: () {
                              ...
                              if (qSlope != null) {
                                ...
                                qSlope.oFactor?.alphaI =
                                    double.tryParse(_alphaI.text);
                                qSlope.oFactor?.alphaJ =
                                    double.tryParse(_alphaJ.text);
                                qSlope.oFactor?.alphaS =
                                    double.tryParse(_alphaS.text);
                                qSlope.oFactor?.betaI =
                                    double.tryParse(_betaI.text);
                                qSlope.oFactor?.betaJ =
                                    double.tryParse(_betaJ.text);
                                qSlope.oFactor?.betaS =
                                    double.tryParse(_betaS.text);
